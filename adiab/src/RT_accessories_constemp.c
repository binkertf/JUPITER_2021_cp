...
// MODIFICATION MADE FROM HERE FOR TESTING
if (temper[l]*TEMP0 < 225. ) {
opamin=kappa(temper[l],5.e-12/RHO0);
} else {
opamin=kappa(225./TEMP0,5.e-12/RHO0);
}
opacity =  DUSTTOGAS*100.*opamin; 
// TILL HERE
