...
#define TEMPRATIO 3.0 // PLEASE TEST
...
#define      	XMSTAR  	  2.4*1.0          // CHANGED 2.4 Amount of Solar Masses
...
#define        	BOUNDTEMP  	  30.0000000000000000000000000  // cooling temperature, we set it now equal to CMB temperature
