...
extern boolean TorqueMon, KineticMon, NoStockholm, TorqStock;
extern boolean AllowFlushLog, QuietOutput, RedefineOptions;
extern boolean RayTracing, RayMirror, CoarseRayTracing;
extern boolean HydroStaticEnforce, HydroStaticReady, SmoothTaper;
extern boolean constSt, d_diff, d_momcon;
