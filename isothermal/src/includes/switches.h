...
boolean TorqueMon = NO, KineticMon = NO, NoStockholm = NO, TorqStock = NO;
boolean AllowFlushLog = NO, QuietOutput = NO, RedefineOptions = NO;
boolean RayTracing = NO, RayMirror = NO, CoarseRayTracing = NO;
boolean HydroStaticEnforce = NO, HydroStaticReady = NO, SmoothTaper = NO;
boolean constSt = NO, d_diff = NO, d_momcon = NO;
