...
struct fluidpatch {
  ...
  ScalarField *Density;         /**< Pointer to the field \f$\rho\f$*/         /**< Pointer to the field \f$\rho\f$*/
  ...
  InterfaceFlux  *MomentumDiffFlux[3];
